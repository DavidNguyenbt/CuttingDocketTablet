...
namespace CuttingDocketTablet
{
    ...
    public class ServerActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            {
                ShiftNm.Text = "";
                DataTable dt = kn.Doc("select distinct ShiftNm, WrkHrId, ShiftId from InlineWrkHrMaster").Tables[0];
                ...
                bd1.SetItems(arstr, (sender, e) =>
                {
                    ...
                    DataTable d = kn.Doc(str).Tables[0];
                ...
                bd1.SetPositiveButton(Temp.GetString("M00032"), (sender, e) => //chọn
                {
                    bd1.Dispose();
                });
